            ...
            <div class="card">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="pg-thumbnail-list">                    
                        <!-- pg thumbnail list -->
                        <div class="hostel-list-img">
                            <a href="pgdetail.php?id=<?php echo $row['id'];?>"><img src="admin/pgimg/<?php echo $row['pg_image'];?>" alt="#" height="186px" width="350px"></a>
                        </div>
                        <div class="hostel-content">
                            <div class="pg-head" height="160px" width="">
                                <h3 class="card-title pg-title"><a href="pgdetail.php?id=<?php echo $row['id'];?>"><?php echo $row['pg_name']; ?></a></h3>
